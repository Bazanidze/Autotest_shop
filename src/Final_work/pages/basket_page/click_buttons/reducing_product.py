...
def reducing_product(selenium):
    with allure.step('Уменьшение количества товара в корзине при нажатии кнопки "Вниз"'):
        ...
        action_chains.move_to_element(down_quantity).move_by_offset(xoffset=15, yoffset=10).click().perform()
