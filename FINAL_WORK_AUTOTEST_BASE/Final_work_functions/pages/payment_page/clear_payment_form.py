...
def clear_payment_form(selenium):
    ...
    with allure.step("Очистка страницы оформления заказа:"):
        with allure.step('Очистка поля ввода "Имя"'):
            ...
            action_chains.click(first_name).key_down(Keys.CONTROL).send_keys(
                "a"
        ...
        with allure.step('Очистка поля ввода "Фамилия"'):
            ...
            action_chains.click(last_name).key_down(Keys.CONTROL).send_keys("a").key_up(
                Keys.CONTROL
        ...
        with allure.step('Очистка поля ввода "Улица, дом"'):
            ...
            action_chains.click(street_house).key_down(Keys.CONTROL).send_keys(
                "a"
            ).key_up(Keys.CONTROL).send_keys(Keys.BACKSPACE).perform()
            action_chains.release()
        ...
        with allure.step('Очистка поля ввода "Город"'):
            ...
            action_chains.click(city).key_down(Keys.CONTROL).send_keys("a").key_up(
                Keys.CONTROL
            ).send_keys(Keys.BACKSPACE).perform()
            action_chains.release()
        ...
        with allure.step('Очистка поля ввода "Область"'):
            ...
            action_chains.click(state).key_down(Keys.CONTROL).send_keys("a").key_up(
                Keys.CONTROL
            ).send_keys(Keys.BACKSPACE).perform()
            action_chains.release()
        ...
        with allure.step('Очистка поля ввода "Почтовый индекс"'):
            ...
            action_chains.click(postcode).key_down(Keys.CONTROL).send_keys("a").key_up(
                Keys.CONTROL
            ).send_keys(Keys.BACKSPACE).perform()
            action_chains.release()
        ...
        with allure.step('Очистка поля ввода "Телефон"'):
            ...
            action_chains.click(number_phone).key_down(Keys.CONTROL).send_keys(
                "a"
            ).key_up(Keys.CONTROL).send_keys(Keys.BACKSPACE).perform()
            action_chains.release()
