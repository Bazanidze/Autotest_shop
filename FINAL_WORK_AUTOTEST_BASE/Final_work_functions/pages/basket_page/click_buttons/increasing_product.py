...
def increasing_product(selenium):
    with allure.step('Увеличение количества товара в корзине при нажатии кнопки "Вверх"'):
        ...
        action_chains.move_to_element(up_quantity).move_by_offset(xoffset=15, yoffset=0).click().perform()
