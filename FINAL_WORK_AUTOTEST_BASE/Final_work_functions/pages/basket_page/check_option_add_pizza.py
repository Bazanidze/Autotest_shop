...
def check_option_add_pizza(selenium):
    basket_name_option_pizza = selenium.find_element(By.XPATH, '(//dd[@class="variation-"])')
    basket_name_option_pizza = basket_normal_name_option_pizza(basket_name_option_pizza.text)
